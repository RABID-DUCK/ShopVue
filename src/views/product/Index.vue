                      ...
                      <div class="col-xl-4 col-lg-6 col-6 " v-for="product in products">
                        <div class="products-three-single w-100  mt-30">
                              ...
                              <div class="row justify-content-between align-items-center">
                                ...
                                <div class="col-lg-6">
                                  <div class="popup-right-content">
                                    ...
                                    <div class="price">
                                      <h2> {{ product.price }}.руб <del> {{product.old_price}}.руб</del></h2>
                                      <h6 v-if="product.is_published == 1"> В наличии</h6>
                          ...
                          <div class="products-three-single-content text-center"> <span>{{ product.category.title}}</span>
                            ...
                            <p><del>{{product.old_price}}.руб</del> {{product.price}}.руб</p>
                          </div>
                        </div>
                      </div>
                    </div>
...
export default {
  ...
  methods: {
    getProducts(){
      this.axios.get('http://market/api/products')
          .then(res => {
